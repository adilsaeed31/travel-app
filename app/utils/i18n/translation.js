export const translation = {
  en: {
    ...
    ManageCard: {
      ...
      viewPin: 'View pin',
      resetPin: 'Reset pin',
      eStatement: 'E-Statements',
      requestPhysicalCard: 'Request physical card',
      replaceCard: 'Replace Card',
      enableEcommerce: 'Enable Ecommerce',
      reactiveCard:'Re-activate',
      reactivateCardSheetTitle:'Re-activate your card',
      reactivateSheetBody:'Please note that all transactions, including standing instructions/recurring payments, will be reactivated.',
      reactiveteSheetBottom:'Re-activate card',
     sopCardCard:'Temporary stop your card',
      stopCardSheetTitle:'Temporary stop your card',
      stopSheetBody:'Please note that by temporarily stop your card all transactions including standing instructions/recurring payments will be rejected',
     stopSheetBottom:'Temporary stop your card',
     cardActivatedSuccessfully:'Card re-activated Successfully',
     cardStopedSuccessfully:'Card temporary stopped Successfully!',
     yourCardIsBloacked:'Your card is currently temporarily stopped',
     pinAutoPlayed:'Pin is displayed sequentially for security reasons.',
     ViewPin:'View Pin',
     CardPin:'Card Pin'
  ...
  ar: {
    ...
    ManageCard: {
      ...
      addToAppleWallet: 'اضف الي محفظة ابل',
      temporaryStop: 'توقف مؤقت',
      viewPin: 'عرض الرمز',
      resetPin: 'إعادة تعيين الرمز',
      eStatement: 'الكشوف الإلكترونية',
      requestPhysicalCard: 'طلب بطاقة فعلية',
      replaceCard: 'استبدال البطاقة',
      enableEcommerce: 'تمكين التجارة الإلكترونية',
      reactiveCard:'اعادة تفعيل',
      reactivateCardSheetTitle:'Re-activate your card',
      reactivateSheetBody:'Please note that all transactions, including standing instructions/recurring payments, will be reactivated.',
      reactiveteSheetBottom:'Re-activate card',
     sopCardCard:'Temporary stop your card',
