...
const SvgLoadIcon = props => (
  <Svg
    ...
    <Path fill="#FFDD45" d="M17 12h12v10H17z" />
    <Path
      fill="#343D45"
      fillRule="evenodd"
      d="M23.25 10c.414 0 .75.305.75.682v2.159c0 .377-.336.682-.75.682s-.75-.306-.75-.682v-2.16c0-.376.336-.681.75-.681Zm0 4.318c.414 0 .75.306.75.682v4.318c0 .377-.336.682-.75.682s-.75-.305-.75-.682V15c0-.377.336-.682.75-.682Z"
      clipRule="evenodd"
    />
    <Path
      fill="#343D45"
      fillRule="evenodd"
      d="M27.28 16.22a.75.75 0 0 1 0 1.06l-3.5 3.5a.75.75 0 0 1-1.06 0l-3.5-3.5a.75.75 0 1 1 1.06-1.06l2.97 2.97 2.97-2.97a.75.75 0 0 1 1.06 0Z"
      clipRule="evenodd"
    />
    <Rect
      width={42}
    ...
    />
    <Defs>
      <ClipPath id="loadIcon_svg__a">
        <Rect width={22} height={16} x={12} y={16} fill="#fff" rx={3} />
      </ClipPath>
    </Defs>
  </Svg>
)
export default SvgLoadIcon
