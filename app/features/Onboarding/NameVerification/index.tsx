              ...
              <Row>
                <RightPad>
                  <TCInput
                    ...
                    isDisabled={!onBoardingProgress?.kycData?.first_name_en}
                    label="First name"
                    onChangeText={text => {
                ...
                <LeftPad>
                  <TCInput
                    ...
                    isDisabled={!onBoardingProgress?.kycData?.first_name_ar}
                    onChangeText={text => {
              ...
              <Row>
                <RightPad>
                  <TCInput
                    ...
                    isDisabled={!onBoardingProgress?.kycData?.second_name_en}
                    onChangeText={text => {
                ...
                <LeftPad>
                  <TCInput
                    ...
                    isDisabled={!onBoardingProgress?.kycData?.second_name_ar}
                    onChangeText={text => {
              ...
              <Row>
                <RightPad>
                  <TCInput
                    ...
                    isDisabled={!onBoardingProgress?.kycData?.third_name_en}
                    onChangeText={text => {
                ...
                <LeftPad>
                  <TCInput
                    label="الاسم الثالث"
                    value={state.third_name_ar}
                    isDisabled={!onBoardingProgress?.kycData?.third_name_ar}
                    onChangeText={text => {
                      setState({...state, third_name_en: text})
                    }}
                  />
              ...
              <Row>
                <RightPad>
                  <TCInput
                    ...
                    isDisabled={!onBoardingProgress?.kycData?.last_name_en}
                    onChangeText={text => {
                ...
                <LeftPad>
                  <TCInput
                    ...
                    isDisabled={!onBoardingProgress?.kycData?.last_name_ar}
                    onChangeText={text => {
